...
public class BytecodeGenerator extends CompilationStage<byte[]> {
    ...
    public byte[] proceed() throws CompilationException {
        if(Main.DEBUG) {
            ...
            MethodVisitor init = classWriter.visitMethod(Opcodes.ACC_PUBLIC, "<init>", "(Ljava/util/List;IILjava/lang/String;Lpw/koper/lang/KoperLang;)V", "(Ljava/util/List<[Ljava/lang/String;>;IILjava/lang/String;Lme/mrfunny/KoperLang;)V", null);
            init.visitCode();
            Label l0 = new Label();
            init.visitLabel(l0);
            init.visitLineNumber(10, l0);
            init.visitVarInsn(Opcodes.ALOAD, 0);
            init.visitMethodInsn(Opcodes.INVOKESPECIAL, "java/lang/Object", "<init>", "()V", true);
            Label l1 = new Label();
            init.visitLabel(l1);
            ...
            init.visitTypeInsn(Opcodes.CHECKCAST, "[Ljava/lang/Object;");
            init.visitMethodInsn(Opcodes.INVOKESTATIC, "java/util/Arrays", "toString", "([Ljava/lang/Object;)Ljava/lang/String;", false);
            ...
            init.visitLocalVariable("other", "I", null, l0, l2, 3);
            init.visitLocalVariable("string", "Ljava/lang/String;", null, l0, l2, 4);
            init.visitLocalVariable("compiler", "Lpw/koper/lang/KoperLang;", null, l0, l2, 5);
            init.visitEnd();
